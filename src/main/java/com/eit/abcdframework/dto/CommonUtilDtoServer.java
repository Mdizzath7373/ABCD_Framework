...
public class CommonUtilDtoServer implements Serializable {
	...
	private String key;
	private List<String> listColumnsValues;
	private String form;
	...
	public String getFirstRowFilter() {
		return firstRowFilter;
	}

	public void setFirstRowFilter(String firstRowFilter) {
		this.firstRowFilter = firstRowFilter;
	}
	...
	public String getLinkscreenname() {
		return linkscreenname;
	}

	public void setLinkscreenname(String linkscreenname) {
		this.linkscreenname = linkscreenname;
	}
	...
	public List<String> getListColumnsValues() {
		return listColumnsValues;
	}

	public void setListColumnsValues(List<String> listColumnsValues) {
		this.listColumnsValues = listColumnsValues;
	}
	...
	public void setAlign(List<String> align) {
		this.align = align;
	}
